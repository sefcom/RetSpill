...
int main(int argc, char **argv) {
  ...
  LAPass.dumpDataOnStackFunc();

  //   if (DumpAll) {
  //     GlobalCtx.structAnalyzer.printFuncPtrSt();
  //     GlobalCtx.structAnalyzer.printFuncTableSt();
  //     GlobalCtx.structAnalyzer.printRefcntSt();
  //     GlobalCtx.structAnalyzer.printCopyinSt();
  //     GlobalCtx.structAnalyzer.printCopyoutSt();
  //     GlobalCtx.structAnalyzer.printBoundarySt();
  //   }
